...
tools: ['vscode', 'execute', 'read', 'edit', 'search', 'web', 'github/*', 'microsoftdocs/mcp/*', 'upstash/context7/*', 'agent', 'ms-python.python/getPythonEnvironmentInfo', 'ms-python.python/getPythonExecutableCommand', 'ms-python.python/installPythonPackage', 'ms-python.python/configurePythonEnvironment', 'todo']
